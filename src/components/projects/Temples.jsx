                        ...
                        <div className="bg-white w-screen mt-20">
                            <div className="mainContainer">
                                ...
                                <div className="text-container normal-text">
                                    <motion.p
                                        {...motionProps}
                                    >Throughout this project, I developed many additional skills using AR Foundation in Unity, including raytracing and image tracking. However, in this project I am most proud to say that this was the first time I fully developed an app from start to finish; from thinking through the experience design in AR and how to configure that in the interface design and front end, to how to make the functionality work using Firebase Realtime Database paired with User Authentication, and developing the back end of the app in XCode. Given this excellent experience, I learned an immense amount about how to redesign conventional apps (like shopping rewards apps) to be more interactive in using augmented reality, and I gained the skills to bring these ideas to life as the developer in addition to the designer.
                                    </motion.p>
                                </div>
