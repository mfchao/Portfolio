...
const state = proxy({
    ...
    titles: ['ASCER Machine Learning Research', 'Neural Synesthesia', 'FlowScape', 'Always', 'Title 5', 'Title 6', 'Cuttlefish', '3D Droop', 'Title 9', 'UCL Assistant', 'Title 11', 'Greening Cities']
})
