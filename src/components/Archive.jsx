...
const state = proxy({
    ...
    titles: ['ASCER Machine Learning Research', 'Assignment[0]: Intro to Comp', 'Title 3', 'Title 4', 'Title 5', 'Title 6', 'Cuttlefish', '3D Droop', 'Title 9', 'UCL Assistant', 'Title 11', 'Greening Cities']
})
