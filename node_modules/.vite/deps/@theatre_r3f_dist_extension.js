...
} from "./chunk-ZSZLIJRD.js";
import {
  allRegisteredObjects,
  editorStore,
  makeStoreKey
} from "./chunk-XQKSG2LL.js";
import {
  require_dist as require_dist3
} from "./chunk-OFIUJGS6.js";
import {
  require_dist
} from "./chunk-X4FBPSOU.js";
import "./chunk-XI3OMGYU.js";
import {
...
var import_studio = __toESM(require_dist2());
var import_studio2 = __toESM(require_dist2());
var import_dataverse = __toESM(require_dist());
var import_dataverse2 = __toESM(require_dist());
var import_core = __toESM(require_dist3());
var import_studio3 = __toESM(require_dist2());
var import_studio4 = __toESM(require_dist2());
var import_studio5 = __toESM(require_dist2());
var import_studio6 = __toESM(require_dist2());
...
var require_zustand = __commonJS({
  "../../node_modules/zustand/index.js"(exports2) {
    ...
    function create4(createState) {
      ...
      var useStore2 = function useStore3(selector, equalityFn) {
        if (selector === void 0) {
      ...
      useStore2[Symbol.iterator] = _regeneratorRuntime__default["default"].mark(function _callee() {
    ...
    module2.exports = function equal(a2, b2) {
      ...
      if (a2 && b2 && typeof a2 == "object" && typeof b2 == "object") {
        ...
        if (length !== Object.keys(b2).length)
          return false;
        for (i3 = length; i3-- !== 0; )
          if (!Object.prototype.hasOwnProperty.call(b2, keys4[i3]))
            return false;
        for (i3 = length; i3-- !== 0; ) {
          var key = keys4[i3];
...
var EMPTY = {};
var catalogue = {};
function checkShallow(a2, b2) {
  if (is.arr(a2) && is.equ(a2, b2))
    return true;
  if (a2 === b2)
    return true;
  return false;
...
function createRenderer(roots2) {
  function diffProps(instance, _a, _c = {}, accumulative = false) {
    ...
    if (accumulative) {
      ...
      for (let i3 = 0; i3 < previousKeys.length; i3++)
        if (!props.hasOwnProperty(previousKeys[i3]))
          entries.unshift([previousKeys[i3], DEFAULT + "remove"]);
    }
  ...
  function applyProps2(instance, data) {
    ...
    changes.forEach(([key, value, isEvent, keys4]) => {
      var _rootState$gl;
      let currentInstance = instance;
      let targetProp = currentInstance[key];
      if (keys4.length) {
        targetProp = keys4.reduce((acc, key2) => acc[key2], instance);
        if (!(targetProp && targetProp.set)) {
          const [name, ...reverseEntries] = keys4.reverse();
  ...
  function createInstance(type, _e2, root3, hostContext, internalInstanceHandle) {
    var _f = _e2, {
      args = []
...
function useLoader(Proto, input, extensions, onProgress) {
  const keys4 = Array.isArray(input) ? input : [input];
  const results = useAsset(loadingFn(extensions, onProgress), Proto, ...keys4);
  return Array.isArray(input) ? results : results[0];
}
useLoader.preload = function(Proto, input, extensions) {
  const keys4 = Array.isArray(input) ? input : [input];
  return useAsset.preload(loadingFn(extensions), Proto, ...keys4);
};
useLoader.clear = function(Proto, input) {
  const keys4 = Array.isArray(input) ? input : [input];
  return useAsset.clear(Proto, ...keys4);
};
...
var Html = React2.forwardRef((_a, ref) => {
  var _b = _a, {
    children,
    eps = 1e-3,
    style,
  ...
  return React2.createElement("group", _extends({}, props, {
    ref: group
  }));
});
...
function create2(type) {
  ...
  return React3.forwardRef((_a, ref) => {
    var _b = _a, {
      args,
      children
    } = _b, props = __objRest(_b, [
    ...
    return React3.createElement("mesh", _extends({
      ref
    }, props), React3.createElement(El, {
      attach: "geometry",
      args
    }), children);
  });
...
var PerspectiveCamera2 = React4.forwardRef((_a, ref) => {
  var _b = _a, {
    makeDefault,
    manual
  } = _b, props = __objRest(_b, [
  ...
  return React4.createElement("perspectiveCamera", _extends({
...
function usePrism(fn, deps, debugLabel) {
  ...
  const atomRef = (0, import_react4.useRef)(null);
  if (!atomRef.current) {
    atomRef.current = new import_dataverse.Atom(fnAsCallback);
  } else {
    atomRef.current.set(fnAsCallback);
  }
  const prsm = (0, import_react4.useMemo)(() => (0, import_dataverse2.prism)(() => {
...
var icons = {
  collection: import_react7.default.createElement(BsFillCollectionFill, null),
  cube: import_react7.default.createElement(GiCube, null),
  lightBulb: import_react7.default.createElement(GiLightBulb, null),
  spotLight: import_react7.default.createElement(GiLightProjector, null),
  sun: import_react7.default.createElement(BiSun, null),
  camera: import_react7.default.createElement(BsCameraVideoFill, null),
  cloud: import_react7.default.createElement(BsCloudFill, null)
};
...
var EditableProxy = ({ storeKey, object }) => {
  ...
  const [setSnapshotProxyObject, editables] = useExtensionStore_default((state) => [state.setSnapshotProxyObject, state.editables], import_shallow.default);
  ...
  return import_react9.default.createElement(import_react9.default.Fragment, null, import_react9.default.createElement("group", {
    ...
    object
  }, (showOverlayIcons || editable.objectConfig.dimensionless && selected !== storeKey) && import_react9.default.createElement(Html, {
    center: true,
    style: {
      pointerEvents: "none",
      transform: "scale(2)",
  ...
  }, import_react9.default.createElement("div", null, icons_default[editable.objectConfig.icon])), editable.objectConfig.dimensionless && import_react9.default.createElement(Sphere, {
    args: [2, 4, 2],
    onClick: (e2) => {
      if (e2.delta < 2) {
        e2.stopPropagation();
...
var TransformControls2 = (0, import_react11.forwardRef)((_a, ref) => {
  ...
  return import_react11.default.createElement("primitive", __spreadValues({
    dispose: null,
    object: controls,
    ref
  }, props));
...
var ProxyManager = ({ orbitControlsRef }) => {
  ...
  const editorObject = getEditorSheetObject();
  const [sceneSnapshot, editables] = useExtensionStore_default((state) => [state.sceneSnapshot, state.editables], import_shallow2.default);
  ...
  return import_react12.default.createElement(import_react12.default.Fragment, null, import_react12.default.createElement("primitive", {
    object: sceneProxy
  }), selected && editableProxyOfSelected && editable && editable.objectConfig.useTransformControls && import_react12.default.createElement(TransformControls_default, {
...
var OrbitControls = (0, import_react14.forwardRef)((_a, ref) => {
  ...
  return React12.createElement("primitive", __spreadValues({
    ref,
    object: controls,
    enableDamping
  }, restProps));
...
function useSnapshotEditorCamera(snapshotEditorSheet, paneId) {
  ...
  const node = import_react17.default.createElement(import_react17.default.Fragment, null, import_react17.default.createElement(PerspectiveCamera2, {
    makeDefault: true,
    ref: camRef,
    position: [0, 102, 0]
...
function usePassValuesFromOrbitControlsToTheatre(cam, orbitControls, objRef) {
  (0, import_react16.useLayoutEffect)(() => {
    ...
    orbitControls.addEventListener("change", onChange2);
    return () => {
      orbitControls.removeEventListener("start", onStart);
      orbitControls.removeEventListener("end", onEnd);
      orbitControls.removeEventListener("change", onChange2);
      if (currentScrub) {
...
function useMeasure2({
  ...
  const [bounds, set] = (0, import_react18.useState)({
    left: 0,
    top: 0,
    width: 0,
    height: 0,
  ...
  const state = (0, import_react18.useRef)({
    element: null,
    scrollContainers: null,
    resizeObserver: null,
    lastBounds: bounds
  ...
  const [forceRefresh, resizeChange, scrollChange] = (0, import_react18.useMemo)(() => {
    const callback = () => {
      if (!state.current.element)
        return;
      const {
    ...
    return [callback, resizeDebounce ? (0, import_debounce2.debounce)(callback, resizeDebounce) : callback, scrollDebounce ? (0, import_debounce2.debounce)(callback, scrollDebounce) : callback];
  ...
  (0, import_react18.useEffect)(() => removeListeners, []);
  return [ref, bounds, forceRefresh];
}
...
function useOnWindowScroll2(onScroll, enabled) {
  (0, import_react18.useEffect)(() => {
    if (enabled) {
      const cb = onScroll;
      window.addEventListener("scroll", cb, {
...
var keys3 = ["x", "y", "top", "bottom", "left", "right", "width", "height"];
var areBoundsEqual2 = (a2, b2) => keys3.every((key) => a2[key] === b2[key]);
...
var ReferenceWindow = ({
  ...
  const [gl] = useExtensionStore_default((state) => [state.gl], import_shallow3.default);
  ...
  const [width, height] = (0, import_react19.useMemo)(() => {
    if (!gl)
      return [0, 0];
  ...
  }, preserveDrawingBuffer ? import_react20.default.createElement(Canvas3, {
    ref: canvasRef,
    width,
    height
  }) : import_react20.default.createElement(Static, null, import_react20.default.createElement(Warning, null, import_react20.default.createElement(TiWarningOutline, {
    size: "3em"
  }), import_react20.default.createElement("code", null, "Please set ", import_react20.default.createElement("pre", null, `gl={{ preserveDrawingBuffer: true }}`), " on the r3f Canvas for the reference window to work."))));
};
...
var EditorScene = ({
  ...
  var _a, _b, _c;
  const [gl, scene, camera] = useThree((store) => [store.gl, store.scene, store.camera], import_shallow4.default);
  ...
  const helpersRoot = useExtensionStore_default((state) => state.helpersRoot, import_shallow4.default);
  ...
  const grid = (0, import_react21.useMemo)(() => new InfiniteGridHelper(), []);
  return import_react22.default.createElement(DragDetectorProvider, null, showGrid && import_react22.default.createElement("primitive", {
    object: grid
  }), showAxes && import_react22.default.createElement("axesHelper", {
    args: [500]
  }), editorCamera, import_react22.default.createElement("primitive", {
    object: helpersRoot
  }), import_react22.default.createElement(ProxyManager_default, {
    orbitControlsRef
  }), import_react22.default.createElement("color", {
    attach: "background",
    args: [0.24, 0.24, 0.24]
  }));
};
...
var SnapshotEditor = (props) => {
  ...
  const [sceneSnapshot, createSnapshot] = useExtensionStore_default((state) => [state.sceneSnapshot, state.createSnapshot], import_shallow4.default);
  (0, import_react21.useLayoutEffect)(() => {
    createSnapshot();
  }, []);
  const onPointerMissed = (0, import_react21.useCallback)(() => {
  ...
  const [toolsContainer, setToolsContainer] = (0, import_react21.useState)();
  (0, import_react21.useEffect)(() => {
    if (!toolsContainer)
      return;
  ...
  if (!editorObject)
    return import_react22.default.createElement(import_react22.default.Fragment, null);
  ...
  return import_react22.default.createElement(import_styled_components2.default.div, {
    style: { overflow: "hidden" }
  }, import_react22.default.createElement(ye, {
    disableVendorPrefixes: true
  }, import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement(GlobalStyle, null), import_react22.default.createElement(Wrapper, null, import_react22.default.createElement(Overlay, null, import_react22.default.createElement(Tools, {
    ref: setToolsContainer
  }), referenceWindowVisibility !== "hidden" && import_react22.default.createElement(ReferenceWindowContainer, null, import_react22.default.createElement(ReferenceWindow_default, {
  ...
  })), !sceneSnapshot && import_react22.default.createElement(WaitForSceneInitMessage, null, "The scene hasn't been initialized yet. It will appear in the editor as soon as it is.")), import_react22.default.createElement(CanvasWrapper, {
    ref
  }, import_react22.default.createElement(Canvas, {
    onCreated: ({ gl }) => {
    ...
    frameloop: "demand",
    onPointerMissed
  }, import_react22.default.createElement(EditorScene, {
    snapshotEditorSheet,
    paneId
  })))))));
};
  ...
  panes: [
    {
      class: "snapshot",
      mount: ({ paneId, node }) => {
        import_react_dom2.default.render(import_react24.default.createElement(SnapshotEditor_default, { paneId }), node);
        function unmount() {
