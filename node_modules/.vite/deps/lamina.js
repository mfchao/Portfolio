...
} from "./chunk-6BGBRMEI.js";
import {
  require_client,
  require_react_dom
} from "./chunk-UXRODVXO.js";
import {
  _extends,
  create,
  extend
} from "./chunk-YSETCIOX.js";
import {
  Color,
  Material,
  MathUtils,
...
// node_modules/leva/node_modules/@use-gesture/core/dist/actions-76b8683e.esm.js
...
function isContainingBlock(element) {
  ...
  return css2.transform !== "none" || css2.perspective !== "none" || (css2.containerType ? css2.containerType !== "normal" : false) || !safari && (css2.backdropFilter ? css2.backdropFilter !== "none" : false) || !safari && (css2.filter ? css2.filter !== "none" : false) || ["transform", "perspective", "filter"].some((value) => (css2.willChange || "").includes(value)) || ["paint", "layout", "strict", "content"].some((value) => (css2.contain || "").includes(value));
}
function isSafari() {
...
var clamp2 = (x3, min3, max3) => x3 > max3 ? max3 : x3 < min3 ? min3 : x3;
var parseNumber = (v4) => {
...
var normalize$2 = (_ref) => {
  ...
  _value = clamp2(_value, min3, max3);
...
function ColorComponent() {
  ...
  return import_react25.default.createElement(Row, {
    input: true
  }, import_react25.default.createElement(Label, null, label), import_react25.default.createElement(PickerContainer, null, import_react25.default.createElement(Color2, {
    value,
    displayValue,
    onChange,
    onUpdate,
...
var sanitize2 = (value, {
  ...
  return [clamp2(Number(min3), MIN, Math.max(MIN, max3)), clamp2(Number(max3), Math.min(MAX, min3), MAX)];
};
var normalize2 = ({
  value,
  min: min3,
...
var DebugLayerMaterial = import_react28.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  var _ref$current, _ref$current2, _ref$current3;
  const ref = import_react28.default.useRef(null);
  (0, import_react28.useImperativeHandle)(forwardRef3, () => ref.current);
  const store = useCreateStore();
  const [layers, setLayers] = import_react28.default.useState({});
  const [path, setPath] = import_react28.default.useState(["", ""]);
  const textureLoader = (0, import_react28.useMemo)(() => new TextureLoader(), []);
  useControls({
    "Copy JSX": button(() => {
  ...
  const [args, otherProps] = (0, import_react28.useMemo)(() => getLayerMaterialArgs({
    ...props3,
    lighting: Lighting
  }), [props3, Lighting]);
  ...
  import_react28.default.useLayoutEffect(() => {
  ...
  import_react28.default.useLayoutEffect(() => {
    ...
    if (root) {
      ...
      levaRoot.render(import_react28.default.createElement(LevaPanel, {
        titleBar: {
  ...
  return import_react28.default.createElement(import_react28.default.Fragment, null, Object.entries(layers).map(([name, layers2], i4) => import_react28.default.createElement(DynamicLeva, {
    key: `${name} ~${i4}`,
    name,
    layers: layers2,
    store,
    setUpdate: setPath
  })), import_react28.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children));
});
...
var LayerMaterial = import_react28.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  const ref = import_react28.default.useRef(null);
  ...
  const [args, otherProps] = (0, import_react28.useMemo)(() => getLayerMaterialArgs(props3), [props3]);
  return import_react28.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children);
});
...
var Depth = import_react28.default.forwardRef((props3, forwardRef3) => {
  return import_react28.default.createElement("depth_", _extends({
    args: getNonUniformArgs(props3),
    ref: forwardRef3
  }, props3));
});
var Color3 = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("color_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Noise = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("noise_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Fresnel = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("fresnel_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Gradient = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("gradient_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Matcap = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("matcap_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Texture2 = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("texture_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Displace = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("displace_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Normal = import_react28.default.forwardRef((props3, ref) => {
  return import_react28.default.createElement("normal_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
