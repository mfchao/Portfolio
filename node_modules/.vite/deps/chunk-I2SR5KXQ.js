...
var RafDriverProvider = ({ driver, children }) => {
  (0, import_react4.useEffect)(() => {
    if (!driver || driver.type !== "Theatre_RafDriver_PublicAPI") {
      throw new Error(`driver in <RafDriverProvider deriver={driver}> has an invalid value`);
    }
  }, [driver]);
  return import_react4.default.createElement(ctx2.Provider, {
    value: { rafDriver: driver }
  }, children);
};
...
`);
      ...
      (0, import_react2.useLayoutEffect)(() => {
        ...
        const unsubscribe = sheetObject.onValuesChange(setFromTheatre, rafDriver);
        return () => {
          unsubscribe();
...
var PerspectiveCamera = editable_default((0, import_react6.forwardRef)((_a, ref) => {
  ...
  return (0, import_react6.createElement)("perspectiveCamera", __spreadValues({
    ref: react_merge_refs_esm_default([cameraRef, ref])
  }, props));
}), "perspectiveCamera");
var OrthographicCamera = editable_default((0, import_react7.forwardRef)((_a, ref) => {
  var _b = _a, { makeDefault, lookAt } = _b, props = __objRest(_b, ["makeDefault", "lookAt"]);
  const set = useThree(({ set: set2 }) => set2);
  const camera = useThree(({ camera: camera2 }) => camera2);
  const size = useThree(({ size: size2 }) => size2);
  ...
  return (0, import_react7.createElement)("orthographicCamera", __spreadValues({
    left: size.width / -2,
    right: size.width / 2,
    top: size.height / 2,
...
//# sourceMappingURL=chunk-I2SR5KXQ.js.map
