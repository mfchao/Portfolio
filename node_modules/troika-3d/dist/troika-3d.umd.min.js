...
"maxInstancedCount"]=b}var da=O(l);l=O(G);let {assign:Ea,forOwn:ea}=g.utils,fa=new e.Vector3,Fa=new e.Vector3,t=function(){const a={callback:function(b){a.value=b},value:null};return a}(),Ga={type:"removed"},B=[],Ha=0,Ia=0;class n extends g.PointerEventTarget{constructor(a,b){super(a);b||(b=this.initThreeObject());b.matrixAutoUpdate=!1;this.threeObject=b;b.$facade=this;let c=!1!==b.isRenderable;c||(b.layers.mask=0);for(;a;){if(a.isObject3DFacade){this._parentObject3DFacade=a;c&&this._addToThreeObjectTree();
...
null,a.dispatchEvent(Ga),!1):!0);let c=this._parentObject3DFacade;P(a)&&c&&c.threeObject===a.parent&&(c._queueRemoveChildObject3D(a.id),c._flushQueuedChildRemovals());this._removeChildIds=null}}destructor(){this.notifyWorld("object3DRemoved");let a=this._parentObject3DFacade;a&&a._queueRemoveChildObject3D(this.threeObject.id);delete this.threeObject;super.destructor()}}["castShadow","receiveShadow","renderOrder","visible"].forEach(a=>{Object.defineProperty(n.prototype,a,{get(){return this.threeObject[a]},
set(b){this.threeObject[a]=b}})});n.prototype.raycastSide=null;ea({position:{x:"x",y:"y",z:"z"},scale:{x:"scaleX",y:"scaleY",z:"scaleZ"},rotation:{x:"rotateX",y:"rotateY",z:"rotateZ",order:"rotateOrder"},quaternion:{x:"quaternionX",y:"quaternionY",z:"quaternionZ",w:"quaternionW"}},(a,b)=>{ea(a,(a,d)=>{Object.defineProperty(n.prototype,a,{get:(new Function(`return function ${a}$get() {
...
}`))()})})});Object.defineProperty(n.prototype,"scale",{get(){return this.threeObject.scale.x},set(a){let b=this.threeObject.scale;if(a!==b.x||a!==b.y||a!==b.z)b.x=b.y=b.z=a,this._matrixChanged||(this._matrixChanged=!0)}});Object.defineProperty(n.prototype,"isObject3DFacade",{value:!0});Ea(n.prototype,{threeObject:null,_parentObject3DFacade:null,_removeChildIds:null,_matrixChanged:!0,_worldMatrixVersion:-1,_worldMatrixVersionAfterLastUpdate:-1,_boundingSphereChanged:!1});g.Facade.defineEventProperty(n,
"onBeforeRender","beforerender");g.Facade.defineEventProperty(n,"onAfterRender","afterrender");let xa=function(){},U=new e.Raycaster,za=new e.Vector2,R=new e.Vector3,T=new e.Matrix4,A=new e.Quaternion,S=new e.Vector3(0,1,0),ya=0,ha=Q(e.PerspectiveCamera,["fov","aspect","near","far"],["focus","filmGauge","filmOffset"]);G=Q(e.OrthographicCamera,"left right top bottom near far".split(" "));class ia extends n{initThreeObject(){let a=new e.Group;a.isRenderable=!1;return a}}class Ja extends n{constructor(a){let b=
new e.Object3D;b.isRenderable=!1;super(a,b);this.html=null;this.exact=!1;this.notifyWorld("addHtmlOverlay",this)}destructor(){this.notifyWorld("removeHtmlOverlay",this);super.destructor()}}class V extends n{set color(a){this.threeObject.color.set(a)}get color(){return this.threeObject.color.getHex()}get shadow(){return this.threeObject.shadow}set shadow(a){g.utils.assignDeep(this.threeObject.shadow,a)}}"intensity distance angle penumbra decay castShadow width height".split(" ").forEach(a=>{Object.defineProperty(V.prototype,
...
"troika_modelMatrixRow"),X=/\bmodelMatrix\b/g,Y=/\bmodelViewMatrix\b/g,Z=/\bnormalMatrix\b/g,oa=/\buniform\s+(int|float|vec[234])\s+$/,D=(a,b,c)=>oa.test(c.substr(0,b))?a:`troika_${a}`,Da=(a,b,c)=>oa.test(c.substr(0,b))?a:`troika_vary_${a}`,W=new WeakMap,{assign:I}=g.utils;class J extends ia{constructor(a){super(a);this._instanceables=Object.create(null);this._batchGeometryPool=new La;this._needsRebatch=!0;this.addEventListener("beforerender",this._setupBatchObjects.bind(this));this.addEventListener("afterrender",
this._teardownBatchObjects.bind(this))}onNotifyWorld(a,b,c){let d=this._notifyWorldHandlers[b];if(d)d.call(this,a,c);else if(this.parent)this.parent.onNotifyWorld(a,b,c)}_setupBatchObjects(a,b,c){c=this._instanceables;a=this._batchObjectsByKey;var d=this._needsRebatch;if(!d)for(var h in a)if(this._getBatchKey(a[h][0].$troikaBatchBaseObj)!==h){d=!0;break}if(d){a=this._batchObjectsByKey=Object.create(null);h=this._batchGeometryPool;for(var m in c){d=c[m];var e=d.threeObject,q=d.instancedThreeObject;
if(q&&e.visible){var k=this._getBatchKey(q);let b=this._getInstanceUniformNames(q);var f=a[k]||(a[k]=[]),p=(k=f[f.length-1])&&k.geometry;if(!p||128===H(p)){k=this._getBatchObject(q);p=k.geometry;var g=p._instanceAttrs.matrix;for(var l=0;3>l;l++)g[l].version++;if(b)for(g=p._instanceAttrs.uniforms,l=b.length;l--;)g[b[l]].version++;f.push(k)}f=H(p);ca(p,f+1);g=p._instanceAttrs.matrix;e=e.matrixWorld.elements;g[0].setXYZW(f,e[0],e[4],e[8],e[12]);g[1].setXYZW(f,e[1],e[5],e[9],e[13]);g[2].setXYZW(f,e[2],
e[6],e[10],e[14]);if(b)for(g=p._instanceAttrs.uniforms,e=b.length;e--;){l=b[e];p=g[l];let a=d._instanceUniforms;l=a&&l in a?a[l]:ba(q.material,l);aa(p,f,l)}d._instancingBatchObject=k;d._instancingBatchAttrOffset=f}else d._instancingBatchObject=d._instancingBatchAttrOffset=null}h.disposeUnused()}h=c=m=0;for(let e in a)for(d=a[e],b.children.push.apply(b.children,d),c++,q=d.length;q--;)m++,h+=H(d[q].geometry);this.notifyWorld("statsUpdate",{"Instancing Batch Groups":c,"Instancing Batches":m,"Instanced Objects":h});
...
a[0],a[4],a[8],a[12]).version++,b[1].setXYZW(d,a[1],a[5],a[9],a[13]).version++,b[2].setXYZW(d,a[2],a[6],a[10],a[14]).version++):(a._instancingBatchObject=a._instancingBatchAttrOffset=null,this._needsRebatch=!0)}}_onInstanceUniformChanged(a,b){if(!this._needsRebatch){let c=a.instancedThreeObject,d=a._instancingBatchObject,h;c&&d&&this._getBatchKey(c)===this._getBatchKey(d)&&(h=d.geometry._instanceAttrs.uniforms[b])?(aa(h,a._instancingBatchAttrOffset,a._instanceUniforms[b]),h.version++):(a._instancingBatchObject=
...
h=this._getInstanceUniformNames(a);let m=this._getInstanceUniformSizes(c,h);d=this._batchGeometryPool.borrow(d,b,m);ca(d,0);let r=Aa(c,h),f,k;h=Object.create(a,{geometry:{value:d},material:{value:r},visible:{value:!0},frustumCulled:{value:!1},customDepthMaterial:{get(){f||(f=r.getDepthMaterial(),f.isShaderMaterial=!0,f.uniformsGroups=f.uniformsGroups||[]);return f}},customDistanceMaterial:{get(){k||(k=r.getDistanceMaterial(),k.isShaderMaterial=!0,k.uniformsGroups=k.uniformsGroups||[],k.uniforms=I({viewMatrix:{value:new e.Matrix4}},
k.uniforms));return k}},modelViewMatrix:{value:function(){let a=new e.Matrix4;a.multiplyMatrices=function(a,b){k&&(k.uniforms.viewMatrix.value.copy(a),k.uniformsNeedUpdate=!0);return e.Matrix4.prototype.multiplyMatrices.call(this,a,b)};return a}()}});h.$troikaBatchBaseObj=a;h.$troikaInstancingManager=this;return h}_teardownBatchObjects(a,b,c){this._batchGeometryPool.releaseAll();this._uniformSizesCache=this._uniformNamesCache=this._batchKeysCache=null;b.children=b.children.filter(a=>a.$troikaInstancingManager!==
this)}destructor(){let a=this._batchGeometryPool;a.releaseAll();a.disposeUnused();super.destructor()}}class La{constructor(){this._poolsByKey=Object.create(null)}borrow(a,b,c){var d=this._poolsByKey;a=d[a]||(d[a]={geometries:[],firstFree:0});d=a.geometries[a.firstFree++];if(!d){d=new e.InstancedBufferGeometry;I(d,b);d.attributes=I({},b.attributes);b=d._instanceAttrs={matrix:[],uniforms:Object.create(null)};for(var h=0;3>h;h++){let a=new e.InstancedBufferAttribute(new Float32Array(512),4);a.setUsage?
a.setUsage(35048):a.dynamic=!0;d.attributes[`troika_modelMatrixRow${h}`]=a;b.matrix[h]=a}for(let a in c)h=c[a],h=new e.InstancedBufferAttribute(new Float32Array(128*h),h),h.setUsage?h.setUsage(35048):h.dynamic=!0,d.attributes[`troika_${a}`]=h,b.uniforms[a]=h;a.geometries.push(d)}return d}releaseAll(){let a=this._poolsByKey;if(a)for(let b in a)a[b].firstFree=0}disposeUnused(){let a=this._poolsByKey;if(a)for(let b in a){let {firstFree:c,geometries:d}=a[b];for(let a=c,b=d.length;a<b;a++){let b=d[a].attributes;
for(let a in b)b.hasOwnProperty(a)&&0!==a.indexOf("troika_")&&delete b[a];try{d[a].dispose()}catch(q){}d[a]._instanceAttrs=null}d.length=c}}}let y=J.prototype;y._notifyWorldHandlers={instanceableAdded:y._onInstanceAdded,instanceableRemoved:y._onInstanceRemoved,instanceableChanged:y._onInstanceChanged,instanceableMatrixChanged:y._onInstanceMatrixChanged,instanceableUniformChanged:y._onInstanceUniformChanged};let Ma={ambient:ja,directional:ka,spot:la,point:ma,hemisphere:na},Na=[{distance:Infinity}],
Oa=new e.Sphere(void 0,Infinity),pa=[null];class qa extends n{initThreeObject(){let a=new e.Scene;"matrixWorldAutoUpdate"in a?a.matrixWorldAutoUpdate=!1:a.autoUpdate=!1;return a}afterUpdate(){let a=this.threeObject;a.background=this.background||null;a.environment=this.environment||null;super.afterUpdate()}describeChildren(){let a={key:"instancingMgr",facade:J,children:this.objects},{lights:b}=this;b&&(a=[a],Array.isArray(b)||(pa[0]=b,b=pa),b.forEach((b,d)=>{let c=b.facade||Ma[b.type];if("function"===
typeof c){let h=g.utils.assign({},b);delete h.type;h.key=b.key||`light${d}`;h.facade=c;a.push(h)}}));return a}set fog(a){let b=this._fogObj;if(a){let c="density"in a,d=c?e.FogExp2:e.Fog;b&&b instanceof d||(b=this._fogObj=new d);b.color.set(a.color);c?b.density=a.density:(b.near=a.near,b.far=a.far)}else b=this._fogObj=null;this.threeObject.fog=b}getBoundingSphere(){return Oa}raycast(a){return Na}}let {assign:Pa,forOwn:Qa}=g.utils,K=new e.Sphere,Ra=Math.sqrt(3);class Sa{constructor(){this.root=null;
this.keysToLeaves=Object.create(null)}putSpheres(a){Qa(a,(a,c)=>{this.putSphere(c,a)})}putSphere(a,b){let {center:c,radius:d}=b;!b||isNaN(d)||isNaN(c.x)?console.warn("Invalid sphere",b):(c._roundedX=1E-8*Math.round(c.x/1E-8),c._roundedY=1E-8*Math.round(c.y/1E-8),c._roundedZ=1E-8*Math.round(c.z/1E-8),this._putSphere(a,b))}_putSphere(a,b){var {center:c}=b,{root:d}=this;let {_roundedX:h,_roundedY:e,_roundedZ:f}=c;if(a in this.keysToLeaves)return this._updateSphere(a,b);if(d)if(d.isLeaf){c=this.root;
let {dataX:m,dataY:k,dataZ:r}=d;if(m===h&&k===e&&r===f)this._insertIntoOctant(a,b,d);else{let g=new z;d=g.cx=Math.round((m+h)/2);let q=g.cy=Math.round((k+e)/2),l=g.cz=Math.round((r+f)/2);g.cr=Math.ceil(Math.max(Math.abs(d-m),Math.abs(q-k),Math.abs(l-r))+1E-5);this.root=g;c.forEachLeafSphere((a,b)=>this._insertIntoOctant(b,a,g));this._insertIntoOctant(a,b,g)}}else this._expandToCoverPoint(h,e,f),this._insertIntoOctant(a,b,this.root);else c=new z,c.isLeaf=!0,c.addSphereData(a,b),this.root=c,this.keysToLeaves[a]=
c}_expandToCoverPoint(a,b,c){for(;!this.root.containsPoint(a,b,c);){let d=this.root,{cx:h,cy:e,cz:f,cr:g}=d,k=new z;k.maxRadius=d.maxRadius;k.sphereCount=d.sphereCount;k.leafCount=d.leafCount;k.cx=h+g*(a<h?-1:1);k.cy=e+g*(b<e?-1:1);k.cz=f+g*(c<f?-1:1);k.cr=2*g;let l=k.getSubOctantIndexForPoint(h,e,f);d.parent=k;d.index=l;k[l]=d;this.root=k}}_insertIntoOctant(a,b,c){let {center:d,radius:h}=b,{_roundedX:e,_roundedY:f,_roundedZ:g}=d;if(c.isLeaf){let {dataX:d,dataY:m,dataZ:r}=c;if(e===d&&f===m&&g===r){c.addSphereData(a,
b);for(b=c.parent;b;b=b.parent)h>b.maxRadius&&(b.maxRadius=h);this.keysToLeaves[a]=c}else{var k=Ta(c);c.parent[c.index]=k;k.addOctantForPoint(c,d,m,r);this._insertIntoOctant(a,b,k)}}else{c.sphereCount++;k=c.getSubOctantIndexForPoint(e,f,g);if(k=c[k])return this._insertIntoOctant(a,b,k);k=new z;k.isLeaf=!0;c.addOctantForPoint(k,e,f,g);k.addSphereData(a,b);for(c=k.parent;c;c=c.parent)h>c.maxRadius&&(c.maxRadius=h),c.leafCount++;this.keysToLeaves[a]=k}}removeSphere(a){var b=this.keysToLeaves[a];if(b){for(var c=
b.parent;c;)c.sphereCount--,c=c.parent;if(1<b.sphereCount)b.removeSphereData(a),b.updateMaxRadii();else{c=b;do{var d=c.parent;(b=d)&&(d[c.index]=null);c=c.parent}while(c&&0===c.sphereCount);if(!b){this.root=null;return}d=null;for(c=b;c;)c.leafCount--,1===c.leafCount&&(d=c),c=c.parent;d?(c=this._findSingleLeaf(d),(b=d.parent)?(b.addOctantForPoint(c,c.cx,c.cy,c.cz),b.updateMaxRadii()):this.root=c):b.updateMaxRadii()}delete this.keysToLeaves[a]}}_updateSphere(a,b){let c=this.keysToLeaves[a],{_roundedX:d,
_roundedY:h,_roundedZ:e}=b.center;if(c.containsPoint(d,h,e)){let f=d!==c.dataX||h!==c.dataY||e!==c.dataZ;1<c.sphereCount&&f?(c.removeSphereData(a),c.updateMaxRadii(),this._insertIntoOctant(a,b,c)):(f&&(c.dataX=d,c.dataY=h,c.dataZ=e),b.radius!==c.maxRadius&&c.updateMaxRadii())}else this.removeSphere(a),this._putSphere(a,b)}_findSingleLeaf(a){function b(a){a.isLeaf&&(d=a)}function c(a){d=null;this.walkBranch(a,b);return d}let d;this._findSingleLeaf=c;return c.call(this,a)}walkTree(a){this.root&&this.walkBranch(this.root,
a)}walkBranch(a,b){if(!1!==b(a)&&!a.isLeaf)for(let c=0;8>c;c++)null!==a[c]&&this.walkBranch(a[c],b)}forEachSphereOnRay(a,b,c){return this._forEachMatchingSphere(a.intersectsSphere.bind(a),b,c)}forEachIntersectingSphere(a,b,c){return this._forEachMatchingSphere(a.intersectsSphere.bind(a),b,c)}_forEachMatchingSphere(a,b,c){function d(d,e){a(d)&&b.call(c,d,e)}this.walkTree(b=>{if(b.isLeaf)b.forEachLeafSphere(d);else if(K.center.set(b.cx,b.cy,b.cz),K.radius=b.cr*Ra+b.maxRadius,!a(K))return!1;return!0})}}
class z{containsPoint(a,b,c){let {cx:d,cy:e,cz:f,cr:g}=this;return a>=d-g&&a<d+g&&b>=e-g&&b<e+g&&c>=f-g&&c<f+g}getSubOctantIndexForPoint(a,b,c){return(c<this.cz?0:4)+(b<this.cy?0:2)+(a<this.cx?0:1)}addOctantForPoint(a,b,c,d){let e=this.getSubOctantIndexForPoint(b,c,d),f=this.cr/2;a.parent=this;a.index=e;a.cx=this.cx+f*(b<this.cx?-1:1);a.cy=this.cy+f*(c<this.cy?-1:1);a.cz=this.cz+f*(d<this.cz?-1:1);a.cr=f;return this[e]=a}findMaxSphereRadius(){let a=0;if(this.isLeaf){var b=this.data;if(1<this.sphereCount)for(let c in b){let d=
b[c].radius;d>a&&(a=d)}else a=b.radius}else for(b=0;8>b;b++)null!==this[b]&&this[b].maxRadius>a&&(a=this[b].maxRadius);return a}updateMaxRadii(){let a=this.findMaxSphereRadius();if(a>this.maxRadius){let b=this;for(;b;)a>b.maxRadius&&(b.maxRadius=a),b=b.parent}else a<this.maxRadius&&(this.maxRadius=a,this.parent&&this.parent.updateMaxRadii())}addSphereData(a,b){var c=this.sphereCount++;if(0===c){this.leafCount=1;this.data=b;this.dataKey=a;let {_roundedX:c,_roundedY:e,_roundedZ:f}=b.center;this.dataX=
c;this.dataY=e;this.dataZ=f}else if(1===c){c=this.data;let d=this.data=Object.create(null);d[this.dataKey]=c;d[a]=b;this.dataKey=null}else 1<c&&(this.data[a]=b);b.radius>this.maxRadius&&(this.maxRadius=b.radius)}removeSphereData(a){let b=this.data;if(b){let c=this.sphereCount--;if(2<c)delete b[a];else if(2===c)for(let c in b){if(c!==a){this.dataKey=c;this.data=b[c];break}}else this.data=null}}forEachLeafSphere(a,b){let c=this.data;if(c)if(1<this.sphereCount)for(let d in c)a.call(b,c[d],d);else a.call(b,
c,this.dataKey)}}Pa(z.prototype,{parent:null,index:-1,cx:0,cy:0,cz:0,cr:0,0:null,1:null,2:null,3:null,4:null,5:null,6:null,7:null,isLeaf:!1,data:null,dataKey:null,dataX:0,dataY:0,dataZ:0,sphereCount:0,leafCount:0,maxRadius:0});let Ta=function(){const a="parent index cx cy cz cr sphereCount leafCount maxRadius".split(" ");return function(b){const c=new z;for(let d=a.length;d--;)c[a[d]]=b[a[d]];return c}}(),{assign:C}=g.utils,L=new e.Vector2,v=new e.Vector3,ra=new e.Raycaster;class E extends g.WorldBaseFacade{constructor(a){super(a);
this._object3DFacadesById=Object.create(null);this._onBgClick=this._onBgClick.bind(this)}afterUpdate(){let {width:a,height:b,antialias:c,backgroundColor:d,contextAttributes:h,_element:f}=this;var g=this._threeRenderer,l=this.rendererClass||e.WebGLRenderer;g&&g instanceof l||(g&&g.dispose(),h=C({alpha:!0,antialias:c},h),(g=f.getContext("webgl2",h)||void 0)||console.info("webgl2 init failed, trying webgl"),g=this._threeRenderer=new l(C({canvas:f,context:g},h)));l=this.shadows;g.shadowMap.enabled=!!l;
l&&"object"===typeof l&&C(g.shadowMap,l);d!==this._bgColor&&(g.setClearColor(new e.Color(d||0),null!=d?1:0),this._bgColor=d);g.outputEncoding=this.outputEncoding||e.LinearEncoding;g.toneMapping=this.toneMapping||e.NoToneMapping;this._updateDrawingBufferSize(a,b,this.pixelRatio||window.devicePixelRatio||1);super.afterUpdate()}describeChildren(){return[this._getCameraDef(),this._getSceneDef()]}_getCameraDef(){let {camera:a}=this;return C({key:"camera",facade:ha,aspect:this.width/this.height},a)}_getSceneDef(){return{key:"scene",
facade:qa,lights:this.lights,objects:this.objects,fog:this.fog,background:this.background,environment:this.environment,onClick:this.onBackgroundClick?this._onBgClick:null}}_updateDrawingBufferSize(a,b,c){let d=this._threeRenderer;d.getSize(L);L.width===a&&L.height===b&&d.getPixelRatio()===c||d.setDrawingBufferSize(a,b,c)}doRender(){function a(a,e){a.call(this._object3DFacadesById[e],d,b,c)}let b=this.getChildByKey("scene").threeObject,c=this.getChildByKey("camera").threeObject,d=this._threeRenderer;
var e=this.eventRegistry;e.forEachListenerOfType("beforerender",a,this);d.render(b,c);e.forEachListenerOfType("afterrender",a,this);if(e=this.onStatsUpdate){let {memory:a,render:b}=d.info,c={"WebGL Draw Calls":b.calls,"WebGL Geometries":a.geometries,"WebGL Textures":a.textures,"WebGL Triangles":b.triangles};b.points&&(c["WebGL Points"]=b.points);b.lines&&(c["WebGL Lines"]=b.lines);e(c)}}getFacadeUserSpaceXYZ(a){a=a.threeObject.matrixWorld.elements;return this.projectWorldPosition(a[12],a[13],a[14])}projectWorldPosition(a,
b,c){v.set(a,b,c);a=this.getChildByKey("camera");a.updateMatrices();a=a.threeObject;v.applyMatrix4(a.matrixWorldInverse);b=v.length()*(0<v.z?-1:1);v.applyMatrix4(a.projectionMatrix);return new e.Vector3((v.x+1)*this.width/2,(1-v.y)*this.height/2,b)}_normalizePointerEvent(a){if(!a.ray){var b=a;if(a.touches){var c=/^touch(end|cancel)$/.test(a.type)?a.changedTouches:a.touches;1===c.length&&(b=c[0])}var d=a.target.getBoundingClientRect();c=((b.clientX||0)-(d.left||0))/(d.width||this.width)*2-1;b=((b.clientY||
0)-(d.top||0))/(d.height||this.height)*-2+1;d=this.getChildByKey("camera");d.updateMatrices();a.ray=d.getRayAtProjectedCoords(c,b)}super._normalizePointerEvent(a)}getFacadesAtEvent(a,b){return a.ray?this.getFacadesOnRay(a.ray,b):null}getFacadesOnRay(a,b){let c=this._updateOctree(),d=null;c&&(ra.ray=a,c.forEachSphereOnRay(a,(a,c)=>{(a=(c=(a=this._object3DFacadesById)&&a[c])&&(!b||b(c))&&c.raycast&&c.raycast(ra))&&a[0]&&(a[0].facade=c,(d||(d=[])).push(a[0]))}));return d}_updateOctree(){let a=this._boundingSphereOctree;
...
g.utils.memoize(()=>new e.BoxGeometry(1,1,1,1,1));class Ya extends w{get geometry(){return ta()}set width(a){this.scaleX=a}get width(){return this.scaleX}set height(a){this.scaleY=a}get height(){return this.scaleY}set depth(a){this.scaleZ=a}get depth(){return this.scaleZ}}let ua=Object.create(null,[["low",32],["medium",64],["high",128]].reduce((a,[b,c])=>{a[b]={get:g.utils.memoize(()=>(new e.CircleGeometry(1,c)).rotateX(-Math.PI/2))};return a},{}));class Za extends w{constructor(a){super(a);this["material.side"]=
this["material.shadowSide"]=e.DoubleSide}get geometry(){return ua[this.detail]||ua.medium}set radius(a){this.scaleX=this.scaleZ=a}get radius(){return this.scaleX}}class $a extends w{get geometry(){return ta()}set size(a){this.scale=a}get size(){return this.scale}}let ab=g.utils.memoize(()=>(new e.PlaneGeometry(1,1,1,1)).rotateX(-Math.PI/2));class bb extends w{constructor(a){super(a);this["material.side"]=this["material.shadowSide"]=e.DoubleSide}get geometry(){return ab()}set width(a){this.scaleX=
a}get width(){return this.scaleX}set depth(a){this.scaleZ=a}get depth(){return this.scaleZ}}let va=Object.create(null,[["low",16,12],["medium",32,24],["high",64,48]].reduce((a,[b,c,d])=>{a[b]={get:g.utils.memoize(()=>new e.SphereGeometry(1,c,d))};return a},{}));class cb extends w{get geometry(){return va[this.detail]||va.medium}set radius(a){this.scale=a}get radius(){return this.scale}}class F extends g.ReactCanvasBase{constructor(a){super(a);this._onCanvasRef=a=>{let b=this.context.onCanvasRef;b&&
b(a);(b=this.props.onCanvasRef)&&b(a)}}render(){let {props:a,context:b}=this;return da["default"].createElement(g.ReactCanvasBase,g.utils.assign({},a,{onCanvasRef:this._onCanvasRef,canvasStyle:a.canvasStyle||b.canvasStyle,worldFacade:a.worldFacade||b.worldFacade||E,worldProps:g.utils.assign({antialias:a.antialias,rendererClass:a.rendererClass,backgroundColor:a.backgroundColor,background:a.background,environment:a.environment,outputEncoding:a.outputEncoding,toneMapping:a.toneMapping,shadows:a.shadows,
camera:a.camera,lights:a.lights,objects:a.objects,fog:a.fog,onBackgroundClick:a.onBackgroundClick},b.worldProps,a.worldProps)}),a.children)}}F.displayName="Canvas3D";F.propTypes=g.utils.assignIf({backgroundColor:l["default"].any,background:l["default"].any,environment:l["default"].any,outputEncoding:l["default"].number,toneMapping:l["default"].number,lights:l["default"].array,camera:l["default"].object,fog:l["default"].object,objects:l["default"].oneOfType([l["default"].array,l["default"].object]).isRequired,
antialias:l["default"].bool,onBackgroundClick:l["default"].func,rendererClass:l["default"].func},g.ReactCanvasBase.commonPropTypes);F.contextType=da["default"].createContext({worldFacade:E,worldProps:{},onCanvasRef:null,canvasStyle:null});Object.defineProperty(f,"Facade",{enumerable:!0,get:function(){return g.Facade}});Object.defineProperty(f,"ListFacade",{enumerable:!0,get:function(){return g.ListFacade}});Object.defineProperty(f,"ParentFacade",{enumerable:!0,get:function(){return g.ParentFacade}});
Object.defineProperty(f,"createDerivedMaterial",{enumerable:!0,get:function(){return u.createDerivedMaterial}});f.AmbientLight3DFacade=ja;f.BoxFacade=Ya;f.Canvas3D=F;f.CircleFacade=Za;f.CubeFacade=$a;f.DirectionalLight3DFacade=ka;f.Group3DFacade=ia;f.HemisphereLight3DFacade=na;f.HtmlOverlay3DFacade=Ja;f.Instanceable3DFacade=sa;f.InstancingManager=J;f.MeshFacade=w;f.Object3DFacade=n;f.OrthographicCamera3DFacade=G;f.PerspectiveCamera3DFacade=ha;f.PlaneFacade=bb;f.PointLight3DFacade=ma;f.RectAreaLight3DFacade=
Ka;f.Scene3DFacade=qa;f.SphereFacade=cb;f.SpotLight3DFacade=la;f.World3DFacade=E;f.makeWorldTextureProvider=function(a){return class extends a{constructor(a){super(a);this.worldTexture=new e.CanvasTexture;let b=this._refireAsInnerEvent.bind(this);Ua.forEach(a=>{function c(a){b(a);d&&d.call(this,a)}let d;this[a]=c;Object.defineProperty(this,a,{set(a){d=a},get(){return c}})})}afterUpdate(){var a=this._worldFacade;let c=this.textureWorld;a&&c&&a instanceof c.facade||(a&&(a.onAfterRender=null,a.destructor()),
c&&(this.worldTexture.dispose(),a=document.createElement("canvas"),a.width=c.width,a.height=c.height,this.worldTexture=new e.CanvasTexture(a),a=this._worldFacade=new c.facade(a),a.onAfterRender=()=>{this.worldTexture.needsUpdate=!0;this.requestRender()}));a&&(a.renderingScheduler=this._getOuterWorld().renderingScheduler,g.utils.assign(a,c,{pixelRatio:1}),a.afterUpdate());super.afterUpdate()}_refireAsInnerEvent(a){var b=this._worldFacade;if(b){var d=a.intersection&&a.intersection.uv;let c=d?Math.round(d.x*
b.width):-1;b=d?Math.round((1-d.y)*b.height):-1;a=a.nativeEvent||a;d=document.createEvent("MouseEvents");d.initMouseEvent(a.type,!0,!0,window,a.detail,c,b,c,b,a.ctrlKey,a.altKey,a.shiftKey,a.metaKey,a.button,null);this.worldTexture.image.dispatchEvent(d)}}_getOuterWorld(){let a=this;for(;a&&!a.isWorld;)a=a.parent;return a}destructor(){let a=this._worldFacade;a&&(a.onAfterRender=null,a.destructor());this.worldTexture.dispose();super.destructor()}}};Object.defineProperty(f,"__esModule",{value:!0})})
